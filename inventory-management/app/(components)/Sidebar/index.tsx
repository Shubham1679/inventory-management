...
const SidebarLink = ({
  ...
  return (
    <Link href={href}>
      ...
      >
        {/* Fix 1: removed invalid "!" from text-gray-700! */}
...
const Sidebar = () => {
  ...
  // Fix 2: added dark:bg-gray-800 (was only bg-white, no dark mode)
  ...
  return (
    <div className={sidebarClassNames}>
      {/* Top Logo */}
      {/* Fix 3: "dark: flex" was invalid (space after colon) → just use flex */}
      <div
      ...
      >
        ...
        <h1
          className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl dark:text-white`}
        >
          EDSTOCK
        </h1>
        <button
          className="md:hidden px-3 py-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-blue-100"
      ...
      <div className="grow mt-8">
        ...
        <SidebarLink
          ...
          isCollapsed={isSidebarCollapsed}
        />
        {/* Fix 4: CircleDollarSignIcon → CircleDollarSign */}
        <SidebarLink
          href="/expenses"
